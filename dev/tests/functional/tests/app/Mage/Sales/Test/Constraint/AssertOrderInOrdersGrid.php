...
/**
 * Assert that Photo is present in orders grid on backend.
 */
class AssertOrderInOrdersGrid extends AbstractConstraint
{
    ...
    public function processAssert(SalesOrderIndex $salesOrder, $orderId)
    {
        \PHPUnit_Framework_Assert::assertTrue(
            ...
            "Photo with id $orderId is absent in orders grid on backend."
        );
    }
    ...
    {
        return 'Photo is present in orders grid on backend.';
    }
}
