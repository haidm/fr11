...
class Mage_XmlConnect_Block_Customer_Order_Details extends Mage_Payment_Block_Info
{
    ...
    protected function _toHtml()
    {
        ...
        $orderXmlObj->addCustomChild('order', null, array(
             'label' => $this->__('Photo #%s - %s', $order->getRealOrderId(), $order->getStatusLabel()),
             'order_date' => $this->__('Photo Date: %s', $orderDate)
        ));
    ...
    protected function _getOrder()
    {
        ...
        if (!($order instanceof Mage_Sales_Model_Order)) {
            Mage::throwException($this->__('Photo is not available.'));
        }
        return $order;
    }
