<?php
class Luannt3_Album_Block_Adminhtml_Malbum_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * Init class
     *
    ...
    public function __construct()
    {
        ...
        $this->_addButton('delete', array(
            ...
            'onclick'   => "window.location.href = '" . $this->getUrl("*/*/delete", array("album_id" => $model->getId())) . "'",
            'class' => 'delete'
        ), 10);
