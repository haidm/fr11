<?php
class Datdt_Album_Adminhtml_TestController extends Mage_Adminhtml_Controller_Action
{
    public function indexAction()
    {
        ...
        $this->loadLayout()
            ->_setActiveMenu('Mega Menu')
            ->_addBreadcrumb(Mage::helper('album')->__('Manage Menu'), Mage::helper('album')->__('Manage Menu'))
            ->_addBreadcrumb(Mage::helper('album')->__('Img'), Mage::helper('Img')->__('Img'))
        ;

        $this->_addContent($this->getLayout()->createBlock('albumblock/adminhtml_mega'))
            ->renderLayout();
        return $this;
    }
...
//           $orderId ?  Mage::helper('tax')->__('Edit order') :  Mage::helper('tax')->__('New Order'))           ->_addContent($this->getLayout()->createBlock('demomodule/adminhtml_order_edit')
