<?php
class NhatBQ_Assignment7_Adminhtml_TestController extends Mage_Adminhtml_Controller_Action
{
    public function indexAction()
    {
        ...
        ;
        $this->_addContent($this->getLayout()->createBlock('assignment7/adminhtml_order'))
            ->renderLayout();
        return $this;
    }
    /**
        ...
        if ($orderId) {
            ...
            if (!$orderModel->getId()) {
                Mage::getSingleton('adminhtml/session')
                    ->addError(Mage::helper('tax')->__('Order not exist!'));
                $this->_redirect('*/*/');
                return;
            }
        }
