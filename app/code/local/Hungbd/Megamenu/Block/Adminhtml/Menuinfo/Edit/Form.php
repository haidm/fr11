 ...
 */
class Hungbd_Megamenu_Block_Adminhtml_Menuinfo_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Init class
     */
    public function __construct()
    {
        ...
        $this->setTitle(Mage::helper('tax')->__('Menu Information'));
    }
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('active', 'text',
            array(
                'name'      => 'active',
                'label'     => Mage::helper('tax')->__('Active'),
                'class'     => 'required-entry',
                'required'  => true,
            )
        );
